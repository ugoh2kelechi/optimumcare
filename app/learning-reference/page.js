							...
							<div className="col-12">
								...
								<div className="ref-table">
									...
									{[
										...
										{ pub: 'BEHAVIORAL AND BRAIN FUNCTIONS', title: 'Preliminary evidence for altered motion tracking based hyperactivity in ADHD siblings.', href: 'https://behavioralandbrainfunctions.biomedcentral.com/articles/10.1186/1744-9081-10-7' },
										{ pub: 'ACTA PSYCHIATRICA SCANDINAVICA', title: 'Objective measurement of motor activity during cognitive performance in adults with attention-deficit/ hyperactivity disorder.', href: 'https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1600-0447.2010.01549.x' },
										{ pub: 'BEHAVIORAL AND BRAIN FUNCTIONS', title: 'Assessing ADHD symptoms in children and adults: evaluating the role of objective measures.', href: 'https://behavioralandbrainfunctions.biomedcentral.com/articles/10.1186/s12993-018-0143-x' },
