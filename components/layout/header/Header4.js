				...
				<div className="wrap-top-bar">
					...
					<div className="top-logo">
						<Link href="/" className="site-logo">
							<img alt="occws" src="https://cdn.builder.io/api/v1/image/assets%2Fab3018047d0c4b508dd0b16003d9a634%2F533d51780c52493abea07782a32fa659?format=webp" />
						</Link>
					</div>
					...
					<div className="header-inner-wrap w-1320">
						...
						<div className="header-left">
							<div className="header-logo-2">
								<Link href="/" className="site-logo">
									<img id="logo_header" alt="occws" src="https://cdn.builder.io/api/v1/image/assets%2Fab3018047d0c4b508dd0b16003d9a634%2F533d51780c52493abea07782a32fa659?format=webp" data-retina="images/logo/logo@2x.png" />
								</Link>
							</div>
